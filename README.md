...
#### Styling
Styling was postponed / rushed (due to issues) but I did consider using something such as Glamorous for the styling, I also considered styling the individual components within their appropriate files but ultimately decided just to leave the styling in the (main) App.js file

##### Relevant Links:
* https://github.com/robinpowered/glamorous-native
* https://glamorous.rocks/getting-started
* https://github.com/patitonar/create-glamorous-native-app 
* https://github.com/paypal/glamorous#related-projects
